...
**Custom_KiCad** is a Fieldpack repo originally authored by Oliver Krause (HumbleOliverKrause / OllieKrause), who is no longer with the company. This repo is under **Oliver-knowledge preservation** mode.
...
KiCad library: custom footprints, symbols, 3D models used across Oliver's hardware designs (control_node and predecessors). If this library disappears, hardware layouts will not render correctly.
