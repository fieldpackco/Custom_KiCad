...
**Repo context:** Custom_KiCad — KiCad library: custom footprints, symbols, 3D models used across Oliver's hardware designs (control_node and predecessors). If this library disappears, hardware layouts will not render correctly.
